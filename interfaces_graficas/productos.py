...
def productos():
    ...
    ventana_productos.geometry("800x600+20+100")
    ...
    boton_agregar = tk.Button(frame_botones, text="Añadir", font=fuente1,
                             bg=color_secundario, fg=color_principal, width=15)
    boton_agregar.pack(side="left", padx=5)

    boton_editar = tk.Button(frame_botones, text="Editar", font=fuente1,
                             bg=color_secundario, fg=color_principal, width=15)
    boton_editar.pack(side="left", padx=5)

    boton_eliminar = tk.Button(frame_botones, text="Eliminar", font=fuente1,
                               bg=color_secundario, fg=color_principal, width=15)
